...
const Header = () => {
    return (
        <header className='w-full h-[10vh] flex items-center justify-between gap-2 shadow-lg px-10'>
            ...
            <div className='w-1/12 flex items-end gap-4 text-xl' >
                <PiDotsThreeVertical  className='' />
